...
<!-- 
            ...
            <section class="pdf-item" style="height: 235px; margin: 15px 15px 0px 15px;">
                <v-row no-gutters style="height: 100px;" >
                    ...
                    <v-col cols="4" >
                        <!-- <div style="margin-left: 12px;margin-top: 6px; margin-botom: 6px">
                            <div class="d-block" style="font-weight: bolder" >Rollux | Persianas Enrollables</div>
                            <div class="d-block">Virrey de Mendoza #1449</div>
                            <div class="d-block">Col. Félix Ireta</div>
                            <div class="d-block">C.P.58070</div>
                            <div class="d-block">Morelia, Michoacán</div>
                            <div class="d-block">Telefono: +52 1 (443) 313 0543</div>
                            <div class="d-block">Correo:  contacto@rolllux.com.mx</div>
                        </div> -->
                    </v-col>
