        ...
        <v-container fluid style="max-width: 1200px" class="my-4">
            <v-row justify="space-between" class="mx-4">
                <v-col cols="12" align-self="center" class="text-center">
                    <div class="d-inline-flex" v-if="getProduct">
                        <h1>{{getProduct.name.slice(0,-1)}}</h1>
                    </div>
                  ...
                  <hr align="center" noshade="noshade" class="divider" style="height: 5px" size="3" width="10%" />
                    ...
                    <v-col v-for="n in getProduct.types" :key="n.id" cols="12" align-self="center" md="3" sm="6">
                        <v-hover  v-slot="{ hover }">
                            ...
                            :to="n.lines > 0?{name: 'Lines', params: {slugType: n.slug}}:{name: 'Products', params: {slugLine: n.slug,slugModel: n.slug}}">
                                {{n.name}}
                            </v-btn>
                        </v-hover>
                    </v-col>
