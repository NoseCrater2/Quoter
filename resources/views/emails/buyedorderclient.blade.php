...
Su orden, identificada como #ORDEN {{ 'PT'.Carbon\Carbon::parse($order->created_at)->format('dmy').'/'.$order->id }} ya casi es suya.<br>
...
<table style="border: 1px solid black; border-collapse: collapse; width: 100%">
    <tbody>
        ...
        <tr>
            <td style="border: 1px solid black;">{{ 'PT'.Carbon\Carbon::parse($order->created_at)->format('dmy').'/'.$order->id }}</td>
